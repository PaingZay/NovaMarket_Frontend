        ...
        <section className="mt-5">
            <div className="container d-flex justify-content-center">
                <form className="w-75 p-3">
                    ...
                    <div className="row mb-3">
                        <label htmlFor="inputContact" className="col-sm-2 col-form-label">Phone number:</label>
                        <div className="col-sm-10">
                            <div className="input-group">
                                <span className="input-group-text" id="addon-wrapping">+65</span>
                                <input type="text" className="form-control" placeholder="Contact number" aria-label="Username"></input>
                            </div>
                        </div>
                    </div>
                    <div className="row mb-3">
                    ...
                    <div className="row mb-3">
                        <label htmlFor="inputStreet" className="col-sm-2 col-form-label">Street:</label>
                        <div className="col-sm-10">
                        ...
                        <div className="col-sm-10 offset-sm-2">
                            <div className="form-check">
                                ...
                                <label className="form-check-label" htmlFor="gridCheck1">
                                    I have read and aggreed to the <a href="">Terms and Conditions</a>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <h1 className="neon-text">Neon Light Text</h1>
        </div> */}
